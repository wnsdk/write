...
import com.example.write.config.oauth.handler.OAuth2FailureHandler;
import com.example.write.config.oauth.handler.OAuth2SuccessHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests((authorize) -> authorize
                                .requestMatchers("/test/**", "/v3/swagger-ui/**", "/v3/api-docs/**", "/h2-console/**", "/prompt/**").permitAll()
...
//                                .logoutSuccessUrl("/")
        ...
        http
                ...
                .cors(corsCustomizer -> corsCustomizer.configurationSource(request -> {
                    ...
                    config.setAllowedOrigins(List.of("http://localhost:5173", "https://www.usewrite.site"));
